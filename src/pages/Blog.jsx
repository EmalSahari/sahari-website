          ...
          <div className="border-t border-white/10">
            {articles.map((a, i) => (
              <Reveal key={a.slug} i={i}>
                <Link
                  to={`/blog/${a.slug}`}
                  className="group grid md:grid-cols-12 gap-3 md:gap-6 py-8 border-b border-white/10 items-baseline transition-colors hover:border-amber-500/30"
                >
                  <span className="md:col-span-2 text-xs text-amber-400 font-medium tracking-widest uppercase tabular-nums">
                  ...
                  <span className="md:col-span-3 inline-flex items-center gap-1.5 text-sm font-medium text-zinc-300 group-hover:text-amber-300 transition-colors md:justify-end">
                    {t('blog.readMore')}
