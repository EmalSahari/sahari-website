...
const TIER_LABELS = {
  single: { en: 'Single page (1,999 DKK)', da: 'Single page (1.999 kr)' },
  standard: { en: 'Standard (3,499 DKK)', da: 'Standard (3.499 kr)' },
  premium: { en: 'Premium (from 7,499 DKK)', da: 'Premium (fra 7.499 kr)' },
}
