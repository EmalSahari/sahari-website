export const translations = {
  en: {
    ...
    'projects.nexbyg.desc': 'A website for NexByg ApS, a certified Danish totalentreprise construction company. I handled it end to end: scoping the content with the client, design and build, contact form, DNS and domain setup. Built to showcase their full range of services (VVS, roofing, asbestos removal, carpentry, masonry, electrical) and make it easy to request a quote.',
  ...
  da: {
    ...
    'projects.nexbyg.title': 'Nexbyg',
    'projects.nexbyg.desc': 'En hjemmeside til NexByg ApS, et autoriseret totalentreprise-byggefirma. Jeg var med fra start til slut: idé og indhold sammen med kunden, design og udvikling, kontaktformular, DNS og domæneopsætning. Bygget til at fremvise hele paletten af ydelser (VVS, tag, asbest, tømrer, murer, el) og gøre det nemt for kunder at få et tilbud.',
