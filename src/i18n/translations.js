export const translations = {
  en: {
    ...
    'projects.fitness.desc': 'A full workout and nutrition tracking web app with user accounts (signup, login, secure sessions). Log meals, track calories, monitor progress, and stay consistent with an AI coach.',
  ...
  da: {
    ...
    'projects.fitness.title': 'FitTrack: Fitness Tracker',
    'projects.fitness.desc': 'En komplet webapp til træning og kost med brugerkonti (signup, login, sikre sessioner). Log måltider, tæl kalorier, følg fremskridt og hold dig konsistent med en AI-træner.',
