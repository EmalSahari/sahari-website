export const translations = {
  ...
  da: {
    ...
    'about.story.p1': 'Jeg startede på YouTube for år tilbage. Prøvede forskellige nicher, lærte hvad der virkede, og hvad der ikke gjorde. Det tog noget tid, før noget rigtigt slog an.',
    'about.story.p2': 'Da kanalerne begyndte at tjene penge, registrerede jeg Sahari som virksomhed i marts 2025. Nogle af de vigtigste dækker arkitektur, militær og rumfart.',
    'about.story.p3': 'På et tidspunkt begyndte jeg også at bygge software, små apps og hjemmesider, først til mig selv, så til venner. Nu gør jeg det som service. Hvis du har brug for en hjemmeside, en app eller noget skræddersyet, er det det Sahari laver.',
