export const translations = {
  en: {
    ...
    'projects.blackstone.desc': 'A concept site for a fictional custom tattoo studio in Copenhagen. Editorial typography (Fraunces + DM Sans), bone-on-black palette, and a deliberate anti-template look. Built to show how the same stack can produce something nothing like Sahari.',
  ...
  da: {
    ...
    'projects.blackstone.title': 'Black Stone Tattoo',
    'projects.blackstone.desc': 'En konceptside for en fiktiv tatovørsalon i København. Editorial typografi (Fraunces + DM Sans), benhvid på sort palette og et bevidst anti-template look. Bygget for at vise at samme stack kan lave noget som intet har at gøre med Sahari.',
